...
<!-- Dark table start -->
    <div class="col-12 mt-5">
        <div class="align-content-center" >
            <a href="{{route('cm-register-form', \App\Helpers\BergyUtils::uuid())}}" class="btn btn-success " ><i class="fa fa-user-plus" ></i> Add New Content Manager</a>
        </div>
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Content Managers</h4>
                <div class="data-tables datatable-dark">
                    <table id="content-managers-table" class="text-center">
                        ...
                        <tbody>
                        @foreach($results['content_managers'] as $content_manager)
                            <tr>
                                <td>{{$count++}}</td>
