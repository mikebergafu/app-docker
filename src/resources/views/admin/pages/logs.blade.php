                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex flex-wrap justify-content-between mb-4 align-items-center">
                                    <h4 class="header-title mb-0">Logs</h4>
                                    <form  action="{{route('admin-log')}}" >
                                        <input class="form-control custom-control-inline" type="date" name="date" placeholder="Search Here"
                                               value="{{$date ? $date->format('Y-m-d') : today()->format('Y-m-d')}}">
                                        <button  class="custom-control-inline" type="submit">Get <i class="ti-arrow-right"></i></button>
                                    </form>
                                </div>
                                <div class="member-box">
                                    <h5>Updated On: <strong>{{$data['lastModified']->format('Y-m-d h:i a')}}</strong> </h5>
                                    <h5>File Size: <strong>{{round($data['size']/1024)}} KB</strong> </h5>
                                    <div class="s-member">

                                        <div class="media align-items-center" style="height: 60vh">
                                            <pre style="height: 100%;overflow: auto">{{$data['file']}}</pre>
                                        </div>
                                    </div>
