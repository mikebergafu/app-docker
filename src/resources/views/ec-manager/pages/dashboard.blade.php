<?php
?>
@extends('ec-manager.master.master')
...
@section('content')
    ...
    @include('ec-manager.master-common.side-nav-bar')
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle"
                                data-toggle="dropdown">{{auth()->guard('admin')->user()->name}}<i
                                    class="fa fa-angle-down"></i></h4>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">Message</a>
                                <a class="dropdown-item" href="#">Settings</a>
                                <a class="dropdown-item"
                                   href="{{route('admin-logout',\App\Helpers\BergyUtils::uuid())}}">Log Out</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sales-report-area sales-style-two">
                    <div class="row">
                        <div class="col-xl-6 col-ml-6 col-md-6 mt-5">
                            ...
                            <?= \Lava::render('ComboChart', 'StocksTable', 'c_div'); ?>
                        </div>

                        <div class="col-xl-6 col-ml-6 col-md-6 mt-5">
                            <div id="temp_div">
                            </div>
                            <?= \Lava::render('ComboChart', 'Finances', 'temp_div'); ?>
                        </div>
