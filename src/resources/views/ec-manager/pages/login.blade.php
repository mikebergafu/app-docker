@extends('content-manager.master.auth-master')
...
@section('content')
    <div class="container">
        ...
        <div class="login-box ptb--100">
            <form action="{{ route('ecm-login') }}" method="post">
                {{ csrf_field() }}
                <div class="login-form-head " style="background-color: #ffc606;">
                    <p style="font-weight: bold; color:white;" >Please Enter your details to login</p>
                </div>
                <div class="login-form-body">
                    ...
                    <div class=" submit-btn-area ">
                        <button id="btn-cm-welcome-link" class="success-but btn btn-warning" type="button"><i class="ti-arrow-left"></i>  Go Back</button>
                    </div>
