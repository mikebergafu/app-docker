            ...
            <form>
                ...
                <div class="login-form-body">
                    <div class="submit-btn-area mt-5">
                        ...
                        <button id="btn-admin-link" class="btn btn-warning" style="font-size: 1.2em;" type="button"><i class="ti-settings text-warning" ></i> Administrator<i class="ti-arrow-right"></i></button>
                    </div>
